...
<# =================================================================
 SE ACTUALIZA PID 
==================================================================#>
$url ='http://192.9.200.69:9101/DB/RF_DB_GET?json={"R_METODO":{"SISTEMA":"VENTAS_PRI_PRE","SP":"SP_UPDATE_FIFO_INTERFAZ_DIS_X_PROCESO_PID"},"R_PARAM":{"PARAMETROS":{"ID_FIFO_INTERFAZ_DIS":$ID_FIFO_INTERFAZ,"ARCHIVO":"$NOMBRE_FILE","PID":$V_PID}},"R_FILTRO":{"PARAMETROS":{}}}'
...
==================================================================#>  
 ...
 Try
 {
       ...
       <# ==========================================================
        ...
        ==========================================================#>
		$url ='http://192.9.200.69:9101/DB/RF_DB_GET?json={"R_METODO":{"SISTEMA":"VENTAS_PRI_PRE","SP":"SP_UPDATE_FIFO_INTERFAZ_DIS_X_PROCESO"},"R_PARAM":{"PARAMETROS":{"ID_FIFO_INTERFAZ_DIS":$ID_FIFO_INTERFAZ,"ARCHIVO":"$NOMBRE_FILE","EJECUTADO":true}},"R_FILTRO":{"PARAMETROS":{}}}'
		$url = $url.Replace('$ID_FIFO_INTERFAZ',$ID_FIFO_INTERFAZ)
		$url = $url.Replace('$NOMBRE_FILE',$NOMBRE_FILE)
